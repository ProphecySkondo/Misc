...
function ErrorPrompt(Message,state)
    if getrenv then
        ...
        prompt:setErrorTitle("Skondo Spy V3 Error")
...
if not getgenv().SimpleSpyExecuted then
    local succeeded,err = pcall(function()
        ...
        if not hookmetamethod then
            ErrorPrompt("Skondo Spy V3 will not function to it's fullest capablity due to your executor not supporting hookmetamethod.",true)
        end
...
newButton("Join Discord",function()
    return "Joins The Skondo Discord"
end,
function()
    setclipboard("https://discord.gg/4THYgrRQd3")
...
if configs.supersecretdevtoggle then
    newButton("Load SSV2.2",function()
        return "Load's Skondo Spy V2.2"
    end,
    function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/exxtremestuffs/SimpleSpySource/master/SimpleSpy.lua"))()
    end)
    newButton("Load SSV3",function()
        return "Load's Skondo Spy V3"
    end,
    function()
