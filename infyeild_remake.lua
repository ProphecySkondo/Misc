...
output = function(comment) warn("[IY]:",tostring(comment))	end
...
CMDs[#CMDs + 1] = {NAME = 'decompile', DESC = 'Uses for loops and executers decompile, copies into clipboard'}
...
addcmd('decompile', {'decompile'}, function(args, speaker)
	notify("Command by discord.gg/4THYgrRQd3")
    loadstring(game:HttpGet("https://raw.githubusercontent.com/ProphecySkondo/Misc/refs/heads/main/dumper.lua"))()
end)
...
output("Script Made, Latest Update As Of Now")
