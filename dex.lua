	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
			...
			},
			{
				...
				"TextLabel",
				{
					BackgroundColor3 = Color3.new(0, 0.01568627450980392, 1),
					BackgroundTransparency = 1,
					Font = 4,
					Name = "Title",
					Parent = {
